...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_gallery_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/gallery.scss */ \"./styles/gallery.scss\");\n/* harmony import */ var _birds_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./birds.js */ \"./js/birds.js\");\n/* harmony import */ var _birdsEN__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./birdsEN */ \"./js/birdsEN.js\");\n/* harmony import */ var _language__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./language */ \"./js/language.js\");\n/* harmony import */ var _player_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./player.js */ \"./js/player.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst addHTMLfiles = (birdsData) => {\r\n\r\n  let list = document.querySelector('.gallery__list')\r\n\r\n  for (let i = 0; i < birdsData.length; i++) {\r\n\r\n    if (Array.isArray(birdsData[i])) {\r\n      addHTMLfiles(birdsData[i])\r\n    } else {\r\n      let item = document.createElement('div')\r\n      item.classList.add('gallery__item')\r\n      list.append(item)\r\n\r\n      let icon = document.createElement('img')\r\n      icon.classList.add('gallery__icon')\r\n      icon.src = birdsData[i].image\r\n      item.append(icon)\r\n\r\n      addPlayer(birdsData[i].audio, item)\r\n\r\n      let name = document.createElement('div')\r\n      name.classList.add('gallery__name')\r\n      name.textContent = birdsData[i].name\r\n      item.append(name)\r\n\r\n      let description = document.createElement('div')\r\n      description.classList.add('gallery__description')\r\n      description.textContent = birdsData[i].description\r\n      item.append(description)\r\n      addListeners(item)\r\n    }\r\n  }\r\n}\r\n\r\nconst addPlayer = (audioLink, block) => {\r\n  const template = document.querySelector('template')\r\n  const audio = template.content.querySelector('.audio-player__sound')\r\n  audio.src = audioLink\r\n  block.append(template.content.cloneNode(true))\r\n}\r\n\r\nconst addListeners = (item) => {\r\n  const PLAYER = {\r\n    audio: item.querySelector('.audio-player__sound'),\r\n    play: item.querySelector('.button-player-controles__img'),\r\n    input: item.querySelector('input'),\r\n    timePassed: item.querySelector('.player-time__passed'),\r\n    timeAll: item.querySelector('.player-time__all'),\r\n    inputVolume: item.querySelector('.track-player__volume_input'),\r\n    iconVolume: item.querySelector('.track-player__volume_img'),\r\n  }\r\n\r\n  PLAYER.play.addEventListener('click', () => {\r\n    ;(0,_player_js__WEBPACK_IMPORTED_MODULE_4__.playPauseAudio)(PLAYER)\r\n  })\r\n\r\n  PLAYER.audio.addEventListener('timeupdate', () => (0,_player_js__WEBPACK_IMPORTED_MODULE_4__.changeTimeTracker)(event, PLAYER))\r\n\r\n  PLAYER.audio.addEventListener('canplaythrough', () => (0,_player_js__WEBPACK_IMPORTED_MODULE_4__.changeAllTimeSong)(PLAYER))\r\n\r\n  PLAYER.input.addEventListener('input', () => (0,_player_js__WEBPACK_IMPORTED_MODULE_4__.setTimePos)(event, PLAYER))\r\n\r\n  PLAYER.inputVolume.addEventListener('input', () => (0,_player_js__WEBPACK_IMPORTED_MODULE_4__.setVolume)(event, PLAYER))\r\n}\r\nconst checkLanguage = () => {\r\n  const language = localStorage.getItem('language')\r\n  const home = document.querySelector('#home')\r\n  const game = document.querySelector('#game')\r\n  const gallery = document.querySelector('#gallery')\r\n  const title = document.querySelector('.gallery__title')\r\n  if (language === 'EN') {\r\n    home.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Starting.EN.home\r\n    game.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Starting.EN.game\r\n    gallery.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Starting.EN.gallery\r\n    title.textContent = 'Gallery'\r\n    addHTMLfiles(_birdsEN__WEBPACK_IMPORTED_MODULE_2__[\"default\"])\r\n  } else {\r\n    home.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Starting.RU.home\r\n    game.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Starting.RU.game\r\n    gallery.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Starting.RU.gallery\r\n    title.textContent = 'Галерея'\r\n    addHTMLfiles(_birds_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])\r\n  }\r\n}\r\n\r\ndocument.addEventListener('DOMContentLoaded', () => {\r\n  checkLanguage()\r\n})\r\n\n\n//# sourceURL=webpack://songsbird/./js/gallery.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("gallery." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
