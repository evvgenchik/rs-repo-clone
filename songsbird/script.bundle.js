...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"TEXT\": () => (/* binding */ TEXT)\n/* harmony export */ });\n\r\n\r\n\r\nconst TEXT = {\r\n  Starting: {\r\n    RU: {\r\n      home: \"Стартовая\",\r\n      game: 'Игра',\r\n      gallery: 'Галерея',\r\n      en: 'Англ',\r\n      ru: 'Рус',\r\n      title: 'Правила просты: угадай птицу по пению и набери максимальное кличество баллов',\r\n      subTitle: 'P.S. фон видео',\r\n      buttonStart: 'Нажми, чтобы начать!',\r\n    },\r\n    EN: {\r\n      home: \"Home\",\r\n      game: 'Game',\r\n      gallery: 'Gallery',\r\n      en: 'EN',\r\n      ru: 'RU',\r\n      title: 'The rules are simple: guess the bird by the song and score the maximum number of points',\r\n      subTitle: 'P.S. background is video',\r\n      buttonStart: 'Press to start!',\r\n    }\r\n  },\r\n  Game: {\r\n    RU: {\r\n      home: \"Стартовая\",\r\n      game: 'Игра',\r\n      gallery: 'Галерея',\r\n      en: 'Англ',\r\n      ru: 'Рус',\r\n      categories: 'Разминка ,Воробьиные, Лесные птицы, Певчие птицы,  Хищные птицы,Морские птицы',\r\n      score: 'очки',\r\n      infoDefolt: 'Послушайте плеер и по звуку выберите птицу из списка',\r\n      mainButton: 'СЛЕДУЮЩИЙ УРОВЕНЬ',\r\n    },\r\n    EN: {\r\n      home: \"Home\",\r\n      game: 'Game',\r\n      gallery: 'Gallery',\r\n      en: 'EN',\r\n      ru: 'RU',\r\n      categories: 'Warm-up ,Passerines, Forest birds, Songbirds, Predator birds, Sea birds',\r\n      score: 'score',\r\n      infoDefolt: 'Listen to the player and select a bird from the list by sound',\r\n      mainButton: 'NEXT LEVEL',\r\n    }\r\n  }\r\n}\n\n//# sourceURL=webpack://songsbird/./js/language.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"birdsDataRandom\": () => (/* binding */ birdsDataRandom),\n/* harmony export */   \"count\": () => (/* binding */ count),\n/* harmony export */   \"rightAnswer\": () => (/* binding */ rightAnswer),\n/* harmony export */   \"score\": () => (/* binding */ score),\n/* harmony export */   \"scoreStep\": () => (/* binding */ scoreStep),\n/* harmony export */   \"shuffle\": () => (/* binding */ shuffle)\n/* harmony export */ });\n/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/style.scss */ \"./styles/style.scss\");\n/* harmony import */ var _birds__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./birds */ \"./js/birds.js\");\n/* harmony import */ var _birdsEN__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./birdsEN */ \"./js/birdsEN.js\");\n/* harmony import */ var _language__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./language */ \"./js/language.js\");\n/* harmony import */ var _view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view */ \"./js/view.js\");\n/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./player */ \"./js/player.js\");\n/* harmony import */ var _img_owl_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../img/owl.png */ \"./img/owl.png\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nlet count = 0\r\nlet score = 0\r\nlet scoreStep = 5\r\nlet birdsDataRandom\r\nlet rightAnswer\r\n\r\nfunction getNamesFromArray(birdsData) {\r\n  let birdsNames = []\r\n  birdsData.map(item => {\r\n    if (item.name) {\r\n      birdsNames.push(item.name)\r\n    } else {\r\n      getNamesFromArray(item)\r\n    }\r\n  })\r\n  return birdsNames\r\n}\r\n\r\nconst shuffle = (array) => {\r\n  for (let i = array.length - 1; i > 0; i--) {\r\n    let j = Math.floor(Math.random() * (i + 1));\r\n    [array[i], array[j]] = [array[j], array[i]];\r\n  }\r\n  return array\r\n}\r\n\r\nconst getRandomBirdsNames = () => {\r\n  let birdsNamesRandom = shuffle(getNamesFromArray(birdsDataRandom[count]))\r\n  return birdsNamesRandom\r\n}\r\n\r\nconst isRightAnswer = (e) => {\r\n  let chosenAnswer = e.target.lastElementChild.textContent;\r\n  let rightChoice = rightAnswer\r\n\r\n  if (chosenAnswer === rightChoice.name) {\r\n    playSoundAnswer(e, true)\r\n    ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.changeRandomHTML)(rightChoice)\r\n    ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.changeInfoHTML)(chosenAnswer)\r\n    changeStepScore(e, 5)\r\n    ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.changeCircleColor)(e, 'green')\r\n    ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.removeDisabledButton)()\r\n  } else {\r\n    playSoundAnswer(e, false)\r\n    changeStepScore(e, 1)\r\n    ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.changeCircleColor)(e, 'red')\r\n    ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.changeInfoHTML)(chosenAnswer)\r\n  }\r\n}\r\n\r\nconst goNextQuestion = () => {\r\n  if (count >= _birds__WEBPACK_IMPORTED_MODULE_1__[\"default\"].length - 1) {\r\n    finishGame()\r\n  } else {\r\n    count += 1\r\n    scoreStep = 5\r\n    getRandomBirdsNames(birdsDataRandom)\r\n    ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.changeChoicesHTML)(getRandomBirdsNames())\r\n  }\r\n}\r\n\r\nconst getRightAnswer = () => {\r\n  rightAnswer = birdsDataRandom[count][Math.floor(Math.random() * birdsDataRandom[count].length)];\r\n}\r\n\r\nconst playSoundAnswer = (e, answer) => {\r\n  if (e.target.classList.contains('active')) {\r\n    return\r\n  }\r\n  let sound = (answer) ? new Audio('./sounds/right.mp3') : new Audio('./sounds/wrong.mp3');\r\n  sound.play()\r\n\r\n  if (answer && _view__WEBPACK_IMPORTED_MODULE_4__.RANDOM.play.classList.contains('play')) {\r\n    (0,_player__WEBPACK_IMPORTED_MODULE_5__.playPauseAudio)(_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM)\r\n  }\r\n}\r\n\r\nconst changeStepScore = (e, number) => {\r\n  if (e.target.classList.contains('active')) {\r\n    return\r\n  }\r\n  if (number == 5) {\r\n    score += scoreStep;\r\n    _view__WEBPACK_IMPORTED_MODULE_4__.RANDOM.score.textContent = `Score: ${score}`\r\n  } else {\r\n    scoreStep -= 1\r\n  }\r\n}\r\n\r\nconst checkLocalStorage = () => {\r\n  const language = localStorage.getItem('language')\r\n  if (language === 'EN') {\r\n    birdsDataRandom = _birdsEN__WEBPACK_IMPORTED_MODULE_2__[\"default\"];\r\n    changeLanguageGame(language)\r\n  } else {\r\n    birdsDataRandom = _birds__WEBPACK_IMPORTED_MODULE_1__[\"default\"];\r\n    changeLanguageGame(language)\r\n  }\r\n  getRandomBirdsNames(birdsDataRandom)\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.changeChoicesHTML)(getRandomBirdsNames())\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.highlightQuestion)()\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.showInfoHtml)()\r\n  getRightAnswer()\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.putDefaultRandomHTML)()\r\n}\r\n\r\nconst changeLanguageGame = (lang) => {\r\n  for (let key in _language__WEBPACK_IMPORTED_MODULE_3__.TEXT) {\r\n\r\n    if (lang === 'EN') {\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.ELEMENTS.home.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.EN.home\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.ELEMENTS.game.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.EN.game\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.ELEMENTS.gallery.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.EN.gallery\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.INFO.defolt.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.EN.infoDefolt\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.BUTTONS.next.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.EN.mainButton\r\n\r\n      for (let i = 0; i < 6; i++) {\r\n        let categoryNameEn = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.EN.categories.split(',')[i]\r\n        _view__WEBPACK_IMPORTED_MODULE_4__.ELEMENTS.categories[i].textContent = categoryNameEn\r\n      }\r\n    }\r\n\r\n    if (lang === 'RU') {\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.ELEMENTS.home.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.RU.home\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.ELEMENTS.game.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.RU.game\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.ELEMENTS.gallery.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.RU.gallery\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.INFO.defolt.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.RU.infoDefolt\r\n      _view__WEBPACK_IMPORTED_MODULE_4__.BUTTONS.next.textContent = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.RU.mainButton\r\n\r\n      for (let i = 0; i < 6; i++) {\r\n        let categoryNameEn = _language__WEBPACK_IMPORTED_MODULE_3__.TEXT.Game.RU.categories.split(',')[i]\r\n        _view__WEBPACK_IMPORTED_MODULE_4__.ELEMENTS.categories[i].textContent = categoryNameEn\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\nconst finishGame = () => {\r\n  localStorage.setItem('result', score)\r\n  window.location.href = '../results.html'\r\n}\r\n\r\ndocument.addEventListener('DOMContentLoaded', () => {\r\n  birdsDataRandom = _birds__WEBPACK_IMPORTED_MODULE_1__[\"default\"];\r\n  getRandomBirdsNames(birdsDataRandom)\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.changeChoicesHTML)(getRandomBirdsNames())\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.highlightQuestion)()\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.showInfoHtml)()\r\n  getRightAnswer()\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.putDefaultRandomHTML)()\r\n  checkLocalStorage()\r\n})\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.BUTTONS.next.addEventListener('click', () => {\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.showInfoHtml)()\r\n  goNextQuestion()\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.highlightQuestion)()\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.resetCircleColor)()\r\n  getRightAnswer()\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.putDefaultRandomHTML)()\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.putButtonDisabled)()\r\n})\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.CHOICES.list.addEventListener('click', (e) => {\r\n  isRightAnswer(e)\r\n  ;(0,_view__WEBPACK_IMPORTED_MODULE_4__.showInfoHtml)(true)\r\n})\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.LANGUAGE.en.addEventListener('click', () => {\r\n  localStorage.setItem('language', 'EN')\r\n  checkLocalStorage()\r\n})\r\n_view__WEBPACK_IMPORTED_MODULE_4__.LANGUAGE.ru.addEventListener('click', () => {\r\n  localStorage.setItem('language', 'RU')\r\n  checkLocalStorage()\r\n})\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM.play.addEventListener('click', () => {\r\n  ;(0,_player__WEBPACK_IMPORTED_MODULE_5__.playPauseAudio)(_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM)\r\n\r\n})\r\n_view__WEBPACK_IMPORTED_MODULE_4__.INFO.play.addEventListener('click', () => {\r\n  ;(0,_player__WEBPACK_IMPORTED_MODULE_5__.playPauseAudio)(_view__WEBPACK_IMPORTED_MODULE_4__.INFO)\r\n})\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM.audio.addEventListener('timeupdate', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.changeTimeTracker)(event, _view__WEBPACK_IMPORTED_MODULE_4__.RANDOM))\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.INFO.audio.addEventListener('timeupdate', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.changeTimeTracker)(event, _view__WEBPACK_IMPORTED_MODULE_4__.INFO))\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM.audio.addEventListener('canplaythrough', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.changeAllTimeSong)(_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM))\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.INFO.audio.addEventListener('canplaythrough', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.changeAllTimeSong)(_view__WEBPACK_IMPORTED_MODULE_4__.INFO))\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM.audio.addEventListener('canplaythrough', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.changeAllTimeSong)(_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM))\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM.input.addEventListener('input', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.setTimePos)(event, _view__WEBPACK_IMPORTED_MODULE_4__.RANDOM))\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.INFO.input.addEventListener('input', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.setTimePos)(event, _view__WEBPACK_IMPORTED_MODULE_4__.INFO))\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.RANDOM.inputVolume.addEventListener('input', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.setVolume)(event, _view__WEBPACK_IMPORTED_MODULE_4__.RANDOM))\r\n\r\n_view__WEBPACK_IMPORTED_MODULE_4__.INFO.inputVolume.addEventListener('input', () => (0,_player__WEBPACK_IMPORTED_MODULE_5__.setVolume)(event, _view__WEBPACK_IMPORTED_MODULE_4__.INFO))\n\n//# sourceURL=webpack://songsbird/./js/script.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _node_modules_css_loader_dist_cjs_js_null_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! -!../node_modules/css-loader/dist/cjs.js!./null.css */ \"./node_modules/css-loader/dist/cjs.js!./styles/null.css\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../node_modules/css-loader/dist/runtime/getUrl.js */ \"./node_modules/css-loader/dist/runtime/getUrl.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_3__);\n// Imports\n\n\n\n\nvar ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../img/minimalFon.jpg */ \"./img/minimalFon.jpg\"), __webpack_require__.b);\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n___CSS_LOADER_EXPORT___.i(_node_modules_css_loader_dist_cjs_js_null_css__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\nvar ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_3___default()(___CSS_LOADER_URL_IMPORT_0___);\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, \"input[type=range] {\\n  -webkit-appearance: none;\\n  -moz-appearance: none;\\n  appearance: none;\\n  outline: none;\\n  overflow: hidden;\\n  height: 7rem;\\n}\\n\\ninput[type=range]::-webkit-slider-runnable-track {\\n  height: 7px;\\n  background-color: #AF9483;\\n}\\n\\ninput[type=range]::-webkit-slider-thumb {\\n  background: #2E4A62;\\n  cursor: pointer;\\n  width: 15px;\\n  height: 15px;\\n  -webkit-appearance: none;\\n  margin-top: -4px;\\n  box-shadow: -200px 0 0 200px #D8AE47;\\n}\\n\\ninput[type=range]::-moz-range-track {\\n  height: 7px;\\n  background-color: #AF9483;\\n}\\n\\ninput[type=range]::-moz-range-thumb {\\n  background: #2E4A62;\\n  cursor: pointer;\\n  width: 15px;\\n  height: 15px;\\n  -webkit-appearance: none;\\n  margin-top: -4px;\\n  box-shadow: -200px 0 0 200px #D8AE47;\\n}\\n\\nhtml {\\n  font-size: 1px;\\n}\\n\\nbody {\\n  font-size: 24rem;\\n  background: url(\" + ___CSS_LOADER_URL_REPLACEMENT_0___ + \") no-repeat;\\n  background-size: cover;\\n  color: #6C4F3D;\\n}\\n\\n[class*=__container] {\\n  width: 1100px;\\n  margin: 0 auto;\\n  padding: 15rem;\\n  border-radius: 3%;\\n}\\n\\n.header {\\n  margin-bottom: 30rem;\\n  padding: 10rem;\\n}\\n\\n.top-header {\\n  display: flex;\\n  align-items: center;\\n  justify-content: space-between;\\n  margin-bottom: 30rem;\\n  gap: 5rem;\\n}\\n.top-header__logo {\\n  display: flex;\\n  align-items: center;\\n}\\n.top-header__logo-img {\\n  max-width: 12%;\\n}\\n.top-header__logo-text {\\n  font-size: 40rem;\\n  color: burlywood;\\n}\\n.top-header__list {\\n  display: flex;\\n  gap: 30rem;\\n}\\n.top-header__link {\\n  font-size: 28rem;\\n}\\n.top-header__link:hover {\\n  color: #A15849;\\n}\\n\\n.main {\\n  padding: 10rem;\\n}\\n\\n.menu {\\n  padding: 10rem;\\n  border-radius: 10rem;\\n}\\n.menu__list {\\n  display: flex;\\n  justify-content: space-around;\\n}\\n.menu__link:hover {\\n  color: #A15849;\\n}\\n\\n.random {\\n  margin-bottom: 30rem;\\n}\\n.random__container {\\n  border: 1px solid #FFF3EB;\\n  border-radius: 2%;\\n  display: flex;\\n  align-items: center;\\n  gap: 20rem;\\n}\\n\\n.icon-random__img {\\n  width: 200rem;\\n  height: 155rem;\\n}\\n\\n.player-random {\\n  flex: auto;\\n}\\n.player-random__info {\\n  display: flex;\\n  align-items: center;\\n  justify-content: space-between;\\n  border-bottom: 1rem solid #000;\\n  margin-bottom: 20rem;\\n}\\n\\n.button-player-controles__img {\\n  border: 1rem solid rgb(6, 38, 111);\\n  border-radius: 50%;\\n  cursor: pointer;\\n}\\n\\n.track-player {\\n  display: flex;\\n  align-items: center;\\n  gap: 40rem;\\n}\\n.track-player__line {\\n  flex: 0 1 70%;\\n}\\n.track-player__input {\\n  width: 100%;\\n  cursor: pointer;\\n}\\n.track-player__volume {\\n  display: flex;\\n  gap: 5rem;\\n}\\n.track-player__volume_img {\\n  width: 15%;\\n}\\n\\n.player-time {\\n  display: flex;\\n  justify-content: space-between;\\n}\\n\\n.quiz__container {\\n  display: flex;\\n  align-items: center;\\n  gap: 50rem;\\n  height: 630rem;\\n  padding: 0;\\n}\\n.quiz__choices {\\n  flex: 0 1 50%;\\n  height: 100%;\\n}\\n.quiz__info {\\n  flex: 0 1 50%;\\n}\\n\\n.choices__wrapper {\\n  padding: 15rem;\\n}\\n.choices__list {\\n  display: flex;\\n  flex-direction: column;\\n  gap: 60rem;\\n}\\n.choices__item {\\n  position: relative;\\n  display: flex;\\n  align-items: center;\\n  gap: 15rem;\\n  height: 100%;\\n}\\n.choices__item::after {\\n  content: \\\"\\\";\\n  width: 100%;\\n  height: 100%;\\n  border-bottom: 1px solid #000;\\n  position: absolute;\\n  top: 30%;\\n  left: 0;\\n}\\n.choices__item:hover {\\n  color: #A15849;\\n  cursor: pointer;\\n}\\n.choices__button {\\n  width: 15rem;\\n  height: 15rem;\\n  border: 2rem solid grey;\\n  border-radius: 50%;\\n}\\n.choices__text {\\n  font-size: 28rem;\\n}\\n\\n.info__wrapper {\\n  display: flex;\\n  flex-direction: column;\\n  gap: 20rem;\\n  padding: 15rem;\\n}\\n.info__img {\\n  width: 200rem;\\n  height: 155rem;\\n  margin: 0 auto;\\n}\\n.info__name {\\n  border-bottom: 1px solid #000;\\n}\\n.info__species {\\n  border-bottom: 1px solid #000;\\n}\\n\\n.player-time {\\n  width: 100%;\\n  display: flex;\\n  align-items: center;\\n}\\n\\n.language__english {\\n  cursor: pointer;\\n}\\n.language__english:hover {\\n  color: #fff;\\n}\\n\\n.language__russian {\\n  cursor: pointer;\\n}\\n.language__russian:hover {\\n  color: #fff;\\n}\\n\\n.main__button {\\n  width: 100%;\\n  background-color: #B4B7BA;\\n  padding: 7rem;\\n  border: none;\\n  cursor: pointer;\\n}\\n.main__button:hover {\\n  background-color: #A15849;\\n}\\n\\n@media (max-width: 1150px) {\\n  [class*=__container] {\\n    width: 900px;\\n  }\\n  html {\\n    font-size: 0.8px;\\n  }\\n}\\n@media (max-width: 920px) {\\n  .header {\\n    margin-bottom: 5rem;\\n  }\\n  .main__random {\\n    margin-bottom: 25rem;\\n  }\\n  html {\\n    font-size: 0.7px;\\n  }\\n  [class*=__container] {\\n    width: 750px;\\n  }\\n}\\n@media (max-width: 768px) {\\n  [class*=__container] {\\n    max-width: 550px;\\n    width: 100%;\\n  }\\n  .menu__list {\\n    column-gap: 20rem;\\n    flex-wrap: wrap;\\n  }\\n  .quiz__container {\\n    display: block;\\n    align-items: center;\\n    gap: 50rem;\\n    height: auto;\\n  }\\n  .quiz__choices {\\n    margin-bottom: 30rem;\\n    padding: 0rem 0 20rem;\\n  }\\n  .quiz .info__wrapper {\\n    display: flex;\\n    flex-direction: column;\\n    gap: 20rem;\\n    padding: 15rem;\\n    text-align: center;\\n  }\\n  .quiz .info__img {\\n    width: 450rem;\\n    height: 100%;\\n    margin: 0 auto;\\n  }\\n  .quiz .choices__text {\\n    font-size: 30rem;\\n  }\\n}\\n@media (max-width: 560px) {\\n  html {\\n    font-size: 0.7px;\\n  }\\n  .top-header__logo-img {\\n    width: 20%;\\n  }\\n  .menu__list {\\n    row-gap: 10rem;\\n  }\\n  .top-header__logo {\\n    column-gap: 10rem;\\n  }\\n  .top-header__logo-text {\\n    font-size: 20px;\\n  }\\n  .top-header__list {\\n    gap: 13rem;\\n  }\\n  .top-header__link {\\n    font-size: 16px;\\n  }\\n  .random__container {\\n    display: block;\\n  }\\n  .random__icon {\\n    margin-bottom: 40rem;\\n  }\\n  .icon-random__img {\\n    width: 450rem;\\n    height: 100%;\\n    margin: 0 auto;\\n  }\\n}\\n/******************JS***************************************/\\n.win {\\n  background-color: #6C4F3D;\\n  max-width: 500rem;\\n  height: 300rem;\\n  margin: 0 auto;\\n  display: flex;\\n  flex-direction: column;\\n  justify-content: space-between;\\n  align-items: center;\\n  gap: 50rem;\\n  padding: 40rem 15rem 30rem;\\n}\\n\\n.menu__link.active {\\n  color: #C0AB8E;\\n  text-decoration: underline;\\n}\\n\\n.choices__item.wrong .choices__button {\\n  background-color: red;\\n}\\n\\n.choices__item.right .choices__button {\\n  background-color: green;\\n}\", \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://songsbird/./styles/style.scss?./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js");

/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js!./styles/null.css":
/*!***************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./styles/null.css ***!
  \***************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n// Imports\n\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, \"/* Указываем box sizing */\\r\\n*,\\r\\n*::before,\\r\\n*::after {\\r\\n  box-sizing: border-box;\\r\\n}\\r\\n\\r\\n/* Убираем внутренние отступы */\\r\\nul[class],\\r\\nol[class] {\\r\\n  padding: 0;\\r\\n}\\r\\n\\r\\n/* Убираем внешние отступы */\\r\\nbody,\\r\\nh1,\\r\\nh2,\\r\\nh3,\\r\\nh4,\\r\\np,\\r\\nul[class],\\r\\nol[class],\\r\\nli,\\r\\nfigure,\\r\\nfigcaption,\\r\\nblockquote,\\r\\ndl,\\r\\ndd {\\r\\n  margin: 0;\\r\\n}\\r\\n\\r\\n/* Выставляем основные настройки по-умолчанию для body */\\r\\nbody {\\r\\n  min-height: 100vh;\\r\\n  scroll-behavior: smooth;\\r\\n  text-rendering: optimizeSpeed;\\r\\n  line-height: 1.5;\\r\\n}\\r\\n\\r\\n/* Удаляем стандартную стилизацию для всех ul и il, у которых есть атрибут class*/\\r\\nul[class],\\r\\nol[class] {\\r\\n  list-style: none;\\r\\n}\\r\\n\\r\\n/* Элементы a, у которых нет класса, сбрасываем до дефолтных стилей */\\r\\na:not([class]) {\\r\\n  text-decoration-skip-ink: auto;\\r\\n}\\r\\na {\\r\\n  text-decoration: none;\\r\\n  color: #000;\\r\\n}\\r\\n\\r\\n/* Упрощаем работу с изображениями */\\r\\nimg {\\r\\n  max-width: 100%;\\r\\n  display: block;\\r\\n}\\r\\n\\r\\n/* Указываем понятную периодичность в потоке данных у article*/\\r\\narticle > * + * {\\r\\n  margin-top: 1em;\\r\\n}\\r\\n\\r\\n/* Наследуем шрифты для инпутов и кнопок */\\r\\ninput,\\r\\nbutton,\\r\\ntextarea,\\r\\nselect {\\r\\n  font: inherit;\\r\\n}\\r\\n\\r\\n/* Удаляем все анимации и переходы для людей, которые предпочитай их не использовать */\\r\\n@media (prefers-reduced-motion: reduce) {\\r\\n  * {\\r\\n    animation-duration: 0.01ms !important;\\r\\n    animation-iteration-count: 1 !important;\\r\\n    transition-duration: 0.01ms !important;\\r\\n    scroll-behavior: auto !important;\\r\\n  }\\r\\n}\\r\\n\", \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://songsbird/./styles/null.css?./node_modules/css-loader/dist/cjs.js");
...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://songsbird/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://songsbird/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://songsbird/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://songsbird/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://songsbird/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("module.exports = __webpack_require__.p + \"48cce7e27db704b2606a.jpg\";\n\n//# sourceURL=webpack://songsbird/./img/minimalFon.jpg?");
...
eval("module.exports = __webpack_require__.p + \"617b3cdf5ca9e1bbbf59.png\";\n\n//# sourceURL=webpack://songsbird/./img/owl.png?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("script." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "songsbird:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatesongsbird"] = (chunkId, moreModules, runtime) => {
